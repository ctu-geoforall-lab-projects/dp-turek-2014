...
Interior orientation of the camera is known accurately therefore it is not adjusted by BBA.
...
The thesis does not deal with determination of weight matrix \ematr{P}. 
Simplest way (there are much better methods) is to represent it as identity matrix. 
All needed information is available to perform a first iteration of non linear least square 
method \ref{sec:non_least}. 
As result of iteration refined values of vector  $\evect{X}$
