...
Modification of GRASS orthorectification processing chain was designed based on the analyses  and subsequently
prototype of processing chain was developed.

The developed processing chain was tested on data comprising of small set of photos.
The data were also processed in state of the art Bingo-F software.
After analysis of the results, it was concluded that accuracy of  the processing chain is comparable to Bingo-F software on the test data. 
