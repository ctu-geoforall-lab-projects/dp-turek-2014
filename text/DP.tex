...
Distances between calculated GCPs object coordinates  to
 its known coordinates compared to distances between the GCPs coordinates form Bingo-F
...
{| c || 
c | c | c | c | c | } 
\caption{Distances between calculated projective center object position
and corresponding position from Bingo-F adjustment.
...
{| c || 
c | c | c | c | c | } 
\caption{Distance between object calculated points and corresponding points
