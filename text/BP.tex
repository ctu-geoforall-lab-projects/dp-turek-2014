...
GPS allows 
to locate position of GPS unit with accuracy ranging  from decimeters to millimeters depending 
...
provides all values of exterior orientation. In order to be information useful it is need to determine 
...
can be refined by BBA. Collinearity equations can be extended to contain these corrections as refined parameters 
 in BBA.
...
professional equipment which is properly calibrated. As a consequence Budget of such a missions
is high. These facts prevents further spreading of rigorous aerial photogrammetry methods.

Nowadays nearly everybody has camera in his pocket therefore there is big demand 
to provide solution which is very simple from the user point of view because 
vast majority of users has limited or no knowledge of photogrammetry. 
Together with spread of UAV, the mapping missions can be performed with much lower 
cost compared to regorous aerial photogrametry mission.
...
to process photos acquired from camera holding in hand or camera mounted on UAV.
...
As consequence of these constraints, the minimum input into processing chain can be just photos
